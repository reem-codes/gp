	...
	\mychapter{System Analysis}
		...
		\newpage\section{Requirement Analysis}
			...
			\newpage\subsection{Functional Requirements}
				\begin{enumerate}
					\item Android client should be able to get system hardware list from
					webserver.
					\item Android client should be able to get each hardware's status from
					webserver.
					\item Android client should get scheduled commands from webserver.
					\item Android client should submit a new a command, might be scheduled,
					to webserver.
					\item Android client should delete a scheduled command from webserver.
					\item Android client should edit a scheduled command from webserver.
					\item Android client should get responses from webserver.
					\item Raspberry pi should get command each 30 sec.
					\item Raspberry pi shall be able to edit action queue.
					\item Raspberry pi shall be able to edit hardware's current
					configuration(status).
					\item Raspberry pi shall be able to submit a command response to server.
					\item Raspberry pi shall be able to submit a new hardware and
